  ...
  setup(props, { emit }) {
    ...
    return () => (
      <>
        ...
        <div class={'z-10 box-border mt-2 ml-1 cursor-pointer'} onClick={()=>popSelectShow.value = !popSelectShow.value}>
          <Icon size="28">
            {search.value === '谷歌' ? (
                <svg
                    class="icon"
          ...
          <div class={['search-selector',popSelectShow.value ? 'active' : '']}>
            <Popselect onSearch={isSearch => {search.value = isSearch;popSelectShow.value = false}}/>
          </div>
